...
summary: "Entenda os principais conceitos financeiros usados no Lyra Agency sem precisar ser contador."
categoryKey: primeiros-passos
moduleKey: finance
productKey: lyra-agency
trailKeys: [primeiros-passos-no-finance, relatorios-financeiros]
order: 2
version: 1
locale: pt-BR
status: published

...
export const TEAM_PAYMENT_DOCUMENT_PRESETS: PaymentTemplatePreset[] = [
  ...
  },
  {
    ...
    description: 'Relatório de presença/frequência do período.',
    color: COLOR_BY_SCOPE.BR,
    metadata: {
      documentType: 'attendance_report',
      countryScope: 'BR',
      applicableRelationshipTypes: ALL_RELATIONSHIP_TYPES,
      bodyHtml: sampleDocumentBody('Relatório de presença'),
      supportsPdf: true,
      supportsPrint: true,
      ...protectedDocumentMetadata('attendance_report', 'BR', 'system:attendance_report'),
    },
  },
  {
    name: 'Relatório de horas',
    description: 'Relatório de horas trabalhadas do período.',
    color: COLOR_BY_SCOPE.BR,
    metadata: {
      documentType: 'timesheet_report',
      countryScope: 'BR',
      applicableRelationshipTypes: ALL_RELATIONSHIP_TYPES,
      bodyHtml: sampleDocumentBody('Relatório de horas'),
      supportsPdf: true,
      supportsPrint: true,
    },
  },
  ...
  },
  {
    ...
    description: 'Report of hours worked in the period.',
    color: COLOR_BY_SCOPE.GLOBAL,
    metadata: {
      documentType: 'timesheet_report',
      countryScope: 'GLOBAL',
      applicableRelationshipTypes: ALL_RELATIONSHIP_TYPES,
      bodyHtml: sampleDocumentBody('Timesheet report'),
      supportsPdf: true,
      supportsPrint: true,
    },
  },

...
@Index('UQ_social_publication_media_order', ['publicationId', 'sortOrder'], {
  unique: true,
})
export class SocialPublicationMediaEntity {
  ...
  @JoinColumn({
    name: 'publication_id',
    foreignKeyConstraintName: 'FK_social_publication_media_publication',
  })
  ...
  @JoinColumn({
    name: 'media_asset_id',
    foreignKeyConstraintName: 'FK_social_publication_media_asset',
  })

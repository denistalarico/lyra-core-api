...
/**
 * MA1 only discovers publishable identities. Publishing, moderation and
 * insights permissions belong to later capability work and are not requested
 * speculatively here. Facebook Login for Business applies these permissions
 * through config_id; this list is the expected/persisted grant contract.
 */

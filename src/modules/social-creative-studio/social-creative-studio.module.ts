...
@Module({
  imports: [PermissionsModule, MediaAssetsModule, SocialOrganicModule, TypeOrmModule.forFeature([CreativeAssetEntity, CreativeAssetVersionEntity, CreativeFolderEntity], 'agency')],
  controllers: [CreativeStudioController],
  providers: [CreativeAssetService, CreativeFolderService, CreativeThumbnailService],
})

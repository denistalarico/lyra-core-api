...
@Unique('UQ_social_creative_asset_versions_number', [
  'creativeAssetId',
  'versionNumber',
])
@Index('IDX_social_creative_asset_versions_asset', [
  'creativeAssetId',
  'versionNumber',
])
@Check('CK_social_creative_asset_versions_number', '"version_number" > 0')
@Check(
  'CK_social_creative_asset_versions_source',
  `"source" IN ('upload', 'replace')`,
)
export class CreativeAssetVersionEntity {
  ...
  @Column({ name: 'thumbnail_media_asset_id', type: 'uuid', nullable: true })

...
import { CreateBrandKit1790800000000 } from './migrations/1790800000000-create-brand-kit';
import { CreateSocialPlannerCore1790900000000 } from './migrations/1790900000000-create-social-planner-core';
import { CreateSocialContentRevisions1791000000000 } from './migrations/1791000000000-create-social-content-revisions';
...
import { AddSocialPlanGeneration1793000000000 } from './migrations/1793000000000-add-social-plan-generation';
import { AddSocialPlanSoftDelete1793100000000 } from './migrations/1793100000000-add-social-plan-soft-delete';
import { CreateSocialBoostTemplates1793200000000 } from './migrations/1793200000000-create-social-boost-templates';
import { CreateSocialCampaignMonitor1793300000000 } from './migrations/1793300000000-create-social-campaign-monitor';
import { CreateSocialCampaignRecommendations1793400000000 } from './migrations/1793400000000-create-social-campaign-recommendations';
import { CreateSocialAdGovernedActions1793500000000 } from './migrations/1793500000000-create-social-ad-governed-actions';
...
import { ResolveLegacyInboxSettingsConflict1795300000000 } from './migrations/1795300000000-resolve-legacy-inbox-settings-conflict';
import { AddSocialOrganicPostIdentity1795400000000 } from './migrations/1795400000000-add-social-organic-post-identity';
import { AddSocialDashboardChannelKey1795500000000 } from './migrations/1795500000000-add-social-dashboard-channel-key';
import { AddOrganicAccountEngagementColumns1795600000000 } from './migrations/1795600000000-add-organic-account-engagement-columns';
import { AddAdVideoCompletionColumns1795700000000 } from './migrations/1795700000000-add-ad-video-completion-columns';
import { AddSocialApprovalViewedAudit1795800000000 } from './migrations/1795800000000-add-social-approval-viewed-audit';
...
import { AddReelAndStoryMeasures1796300000000 } from './migrations/1796300000000-add-reel-and-story-measures';
...
export const AgencyDataSource = new DataSource({
  ...
  migrations: [
    ...
    CreateSocialPlannerCore1790900000000,
    CreateSocialContentRevisions1791000000000,
    ...
    AddSocialPlanSoftDelete1793100000000,
    CreateSocialBoostTemplates1793200000000,
    CreateSocialCampaignMonitor1793300000000,
    ...
    ResolveLegacyInboxSettingsConflict1795300000000,
    AddSocialOrganicPostIdentity1795400000000,
    AddSocialDashboardChannelKey1795500000000,
    AddOrganicAccountEngagementColumns1795600000000,
    AddAdVideoCompletionColumns1795700000000,
    AddSocialApprovalViewedAudit1795800000000,
    ...
    AddReelAndStoryMeasures1796300000000,

...
/**
 * Seeds the LeadFlow Event Contract permission keys (Event Contract sprint,
 * blueprint section 15). All four keys are new; the module itself is
 * contract-only and in-memory, so this is its only migration.
 */
const PERMISSION_KEYS = [
  'leadflow.events.catalog.view',
  'leadflow.events.validate.admin',
  'leadflow.events.runtime.preview.admin',
  'leadflow.events.developer.manage.owner_only',
];

export class AddLeadflowEventsPermissions1783800000000
  implements MigrationInterface
{
  name = 'AddLeadflowEventsPermissions1783800000000';

...
/**
 * Seeds the LeadFlow Agents permission keys. The pre-existing catalog keys were
 * never seeded to the database, so they are (re)inserted here together with the
 * new keys introduced by the Agents Config & Governance sprint.
 */
const PERMISSION_KEYS = [
  ...
  'leadflow.agents.agent.publish.admin',
  'leadflow.agents.channel.manage.admin',
  'leadflow.agents.runtime.preview.admin',
  'leadflow.agents.agent.delete.owner_only',
  'leadflow.agents.developer.manage.owner_only',
  'leadflow.agents.system.manage.owner_only',
];

export class AddLeadflowAgentsPermissions1783500000000
  implements MigrationInterface
{
  name = 'AddLeadflowAgentsPermissions1783500000000';

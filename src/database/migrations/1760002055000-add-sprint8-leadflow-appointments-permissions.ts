...
const PERMISSION_KEYS = [
  ...
  'leadflow.appointments.item.create.client',
  'leadflow.appointments.item.update.assigned',
  'leadflow.appointments.item.update.client',
  'leadflow.appointments.item.delete.owner_only',
];

export class AddSprint8LeadflowAppointmentsPermissions1760002055000
  implements MigrationInterface
{
  name = 'AddSprint8LeadflowAppointmentsPermissions1760002055000';
